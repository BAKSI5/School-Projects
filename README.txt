...
Part 2. For the second assignment was written a program named rate.py to calculate the interest rate, using the values from the first assignment, and the total amount of money that will be paid over the full term of the loan received as a result from interest.py.
First, performing some algebraic maanipulations on the formula it was formed a solution that specifies r in terms of Total Amount, P, n and t. The result should match to the input rate r from the Part 1.
The result of the computation is 0.03500000000000014 what is very close to the r = 0.035 from Part 1. The difference of 0.00000000000000014 can be the reason of using mathematical complex functions such as dividing and exponentiation. Also r is a float number and when we do not round floating-point numbers in Python it can have a maximum value that is system-dependent.
